...
const ProductCard: React.FC<ProductCardProps> = ({ title, description, link }) => {
  return (
    <div className="bg-white border border-gray-100 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-6 flex flex-col h-full">
      <div className="mb-4">
        <h3 className="text-xl font-semibold mb-1">{title}</h3>
        <div className="h-1 w-12 bg-gradient-to-r from-aurabyt-purple to-aurabyt-blue rounded-full"></div>
      </div>
