...
const Services = () => {
  ...
  return <div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-12">
              {[<Code />, <BarChart />, <Server />].map((icon, i) => <div key={i} className="w-12 h-12 bg-white/10 rounded-lg flex items-center justify-center text-white animate-fade-in" style={{
      ...
      {services.map((serviceCategory, index) => <section key={serviceCategory.id} id={serviceCategory.id} className={`py-20 ${index % 2 === 1 ? 'bg-gray-50' : 'bg-white'} relative overflow-hidden`}>
          {/* Background elements */}
          {index % 2 === 0 && <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {serviceCategory.items.map((service, i) => <div key={i} className="bg-white rounded-xl shadow-md p-8 hover-card relative service-card group" style={{
            transitionDelay: `${i * 100}ms`
                  ...
                  <ul className="space-y-2 mb-6">
                    {service.benefits.map((benefit, j) => <li key={j} className="flex items-start">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {service.technologies.map((tech, k) => <span key={k} className="px-2 py-1 bg-gray-100 text-gray-700 rounded-md text-sm">
                        {tech}
                      </span>)}
                  </div>
                </div>)}
      ...
      <section className="py-16 bg-purple-gradient text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link to="/contact" className="inline-block px-8 py-4 bg-white text-primary rounded-lg font-bold hover:bg-gray-100 transition-colors btn-hover-shine group">
              Contact Us
